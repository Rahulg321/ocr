...
export default function FileUploadSection() {
  return (
    <div className="w-full max-w-4xl mx-auto p-8 bg-gray-50 rounded-3xl">
      <div className="relative z-10">
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mt-4 max-w-lg mx-auto">
            Stop wasting time with manual data entry. Let our AI-powered OCR do
            the heavy lifting – fast, accurate, and hassle-free.
          </p>

          <div className="mt-8">
            <Button className="bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-6 rounded-full h-auto">
              Upload file
